...
if [[ ! -s AALlabel.nii.gz  ]] ; then 
  ${gitdir}/src/antsRegistrationAAL.sh -d 3 -f anatomy/highres001.nii.gz -m ${gitdir}/template/template.nii.gz  -o AAL -t d  -l ${mybasedir}/../Haxby2001/template/aal.nii.gz 
fi
